...
import CardAppleWatch2 from 'src/views/ui/cards/basic/CardAppleWatch2'
...
const CrmDashboard = () => {
  ...
  useEffect(() => {
    setInterval(()=>{
      var labelObject = document.querySelectorAll('.MuiTablePagination-selectLabel,.css-warohq-MuiTablePagination-selectLabel')[0];
      if(labelObject)
        labelObject.innerHTML="Wierszy na stronie";
    }, 1000);
  }, []);
