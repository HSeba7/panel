...
const CompanyInfo = () => {
	...
	return (
		<Card
			sx={{ padding: "10px", paddingLeft: "1.25rem", paddingRight: "1.25rem" }}
		>
			<form>
				<Grid container spacing={6}>
					...
					<Grid item xs={12} sm={3}>
						<TextField
							fullWidth
							label="Nazwa Banku"
							placeholder="Bank Milennium"
							defaultValue="Bank Milennium"
						/>
					</Grid>
					<Grid item xs={12} sm={3}>
						<TextField
							fullWidth
							label="BIC/SWIFT"
							placeholder="BIGB-PLPW"
							defaultValue="BIGB-PLPW"
						/>
					</Grid>
					<Grid item xs={12} sm={6}>
						<TextField
						...
						<Grid item xs={12}>
							...
							>
								<AlertTitle sx={{ mb: ".15rem" }}>
									Twoje konto bankowe nie zostało jeszcze potwierdzone. Po
									wykonaniu przelewu bankowego w wysokości 1zł nasi pracownicy
									sprawdzą zgodność przesłanych danych. Każda zmiana numeru
									rachunku wymaga potwierdzenia danych przez pracownika Fifth
									Factor.
								</AlertTitle>
							</Alert>
						</Grid>
...
export default CompanyInfoBlocked;
