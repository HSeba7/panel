...
const CompanyInfoAdd = () => {
  ...
  return (
    <Card sx={{paddingTop:'10px', paddingLeft:'1.25rem', paddingRight:'1.25rem'}}>
      <form>
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} sm={3}>
            <TextField fullWidth label='Numer NIP' placeholder='123-456-78-90' />
          </Grid>
          <Grid item xs={12} sm={3}>
            <TextField fullWidth label='Numer REGON' placeholder='123456789' />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              fullWidth
          ...
          <Grid item xs={12} sm={3}>
            <TextField fullWidth label='Miasto' placeholder='Warszawa'  />
          </Grid>
          <Grid item xs={12} sm={3}>
            <TextField fullWidth label='Kod Pocztowy' placeholder='03-288'  />
          </Grid>
          ...
          <Grid item xs={12} sm={3}>
            <TextField fullWidth label='Nazwa Banku' placeholder='Bank Milennium'/>
          </Grid>
          <Grid item xs={12} sm={3}>
            <TextField fullWidth label='BIC/SWIFT' placeholder='BIGB-PLPW' />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              fullWidth
          ...
          <Grid item xs={12} sx={{ pt: theme => `${theme.spacing(7)} !important`, paddingBottom:'1.5rem !important' }}>
